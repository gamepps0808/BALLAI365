...
const AnalysisSchema = z.object({
  ...
  handicapVerdict: z
    ...
    .nullable()
    .describe(
      "คำตัดสินแฮนดิแคปที่เส้น odds.asianHandicapLine — ฝั่งที่ 'กินราคาต่อรอง' จริง: HOME=ทีมแรกกินเส้น, AWAY=ทีมที่สอง(รอง)กินเส้น. ต้องเลือกฝั่งใดฝั่งหนึ่งเสมอ ห้ามก้ำกึ่ง — ถ้าสูสีให้เลือกฝั่งที่ได้เปรียบกว่าแม้เพียงเล็กน้อย. ใช้ดุลพินิจจากความน่าจะเป็นของ 'ส่วนต่างประตู' เทียบเส้น — null เฉพาะเมื่อไม่มีตลาดแฮนดิแคป"
    ),
  keyPlayers: z
    .object({
...
12. แฮนดิแคป (สำคัญมาก — หัวใจความแม่นของราคาต่อรอง): ระบบคิดฝั่งกินราคาต่อรอง "จาก expectedScore เทียบเส้น asianHandicapLine" เสมอ ดังนั้น expectedScore ของคุณต้องสะท้อน "ส่วนต่างประตูจริง" ที่คุณเชื่อ
    - ถ้าเชื่อว่าตัวเต็งกินเส้น (เช่น -2.75) ต้องทายสกอร์ที่ชนะเกินเส้นนั้น (เช่น 3-0, 4-1) · ถ้าเชื่อว่าบอลรองรับลูกได้คุ้ม ต้องทายสกอร์ที่ตัวเต็งชนะไม่ถึงเส้น (เช่น 2-0 ที่เส้น -2.75)
    - ห้ามทายสกอร์อย่างหนึ่งแล้วคิดราคาต่อรองอีกอย่าง — สกอร์ที่ทาย "คือ" มุมมองส่วนต่างประตูของคุณ ราคาต่อรองต้องไม่สวนทางสกอร์
    - handicapVerdict: บอกฝั่งที่คุณเชื่อว่ากินเส้น (HOME/AWAY) — ระบบใช้เป็นตัวตัดสินเฉพาะตอนสกอร์ลงเท่าเส้นพอดี (push) · ให้สอดคล้องกับ handicapAssessmentTh ที่เขียน`;
